...
export const ApiDocsPage: React.FC = () => {
  ...
  // ΓöÇΓöÇ Code Examples ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
return redirect($result['data']['paymentLink']);`;
  ...
  const reactCreate = `// ΓÜá∩╕Å API Key TIDAK boleh ada di React frontend!
...
if ($status === 'PAID') {
  ...
  const reactGetInvoice = `// Di server Express ΓÇö proxy ke ADMS dengan x-api-key
...
// Di React ΓÇö polling status dari backend Anda sendiri
    ...
    <div className="min-h-screen -m-4 sm:-m-6 lg:-m-8">
      ...
      <div className="flex">
        ...
        <main className="flex-1 max-w-3xl px-6 lg:px-10 py-10 space-y-0">
          ...
          <section id="quickstart" className="scroll-mt-24">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-8">
              {[
                ...
                { step: '02', title: 'Buat Invoice', desc: 'POST ke /api/v1/payments. Dapat paymentLink ΓÇö kirim ke customer untuk scan QRIS.' },
            ...
            <div className="bg-[#0D1B2A] rounded-xl border border-[#1E3A5F] p-5">
              ...
              <div className="flex flex-col gap-3">
                {[
                  ...
                  { from: 'ADMS',        label: '201 Created ΓåÆ invoiceNumber + paymentLink', sub: 'Simpan invoiceNumber di database Anda', arrow: true },
                  ...
                  { from: 'Sistem Anda', label: 'Verifikasi HMAC ΓåÆ update status order', sub: 'Balas 200 OK untuk konfirmasi terima', arrow: false },
                ].map((item, i) => (
          ...
          {/* ΓöÇΓöÇ CARA DAPAT API KEY ΓöÇΓöÇ */}
          <section id="get-api-key" className="scroll-mt-24">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-6 leading-relaxed">
              API Key dibuat oleh admin ADMS. Tim IT/developer sistem lain tidak membuat sendiri ΓÇö cukup minta ke admin,
              ...
              {[
                {
                  ...
                  desc: 'Login sebagai ADMIN ke portal ADMS ΓåÆ sidebar kiri ΓåÆ "Client Apps".',
                  icon: UserCheck,
                },
                {
                  num: '2',
                ...
                {
                  num: '3',
                  title: 'Salin API Key ΓÇö hanya muncul sekali',
              ...
              <table className="w-full text-xs">
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                  ...
                  <tr>
                    ...
                    <td className="py-3 pr-4 text-slate-600 dark:text-slate-400"><code className="font-mono">application/json</code> ΓÇö untuk request dengan body.</td>
                  </tr>
                </tbody>
              </table>
            </div>
...
ADMS_WEBHOOK_SECRET=sama_dengan_jwt_secret_adms`} />
          ...
          <section id="create-payment" className="scroll-mt-24">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-5 leading-relaxed">
              ...
              dan <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded text-xs font-mono">paymentLink</code> ΓÇö kirimkan link ini ke customer untuk scan QR.
            </p>
                ...
                <table className="w-full text-xs">
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                    {[
                      ...
                      { name: 'description', type: 'string', required: true, desc: 'Keterangan tagihan ΓÇö tampil di halaman QR customer.' },
            ...
            <div className="mt-4">
              <p className="text-[11px] font-black text-slate-500 uppercase tracking-widest mb-2">Response Sukses ΓÇö 201 Created</p>
  ...
  "data": {
    ...
    "expiredAt":     "2026-08-17T11:00:00.000Z"
          ...
          <section id="get-by-invoice" className="scroll-mt-24">
            ...
            <div className="mt-4">
              <p className="text-[11px] font-black text-slate-500 uppercase tracking-widest mb-2">Response Sukses ΓÇö 200 OK</p>
              <CodeBlock lang="json" code={`{
  "success": true,
  "data": {
    "id":            42,
    ...
    "expiredAt":     "2026-08-17T11:00:00.000Z"
          ...
          <section id="webhook" className="scroll-mt-24">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-5 leading-relaxed">
              ...
              ΓÇö selalu verifikasi sebelum memproses.
            </p>
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden mb-5">
              ...
              <table className="w-full text-xs">
                <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                  {[
                    { name: 'X-ADMS-Signature', desc: 'sha256=<hmac-hex> ΓÇö verifikasi sebelum proses.' },
          ...
          {/* ΓöÇΓöÇ INTEGRASI LARAVEL ΓöÇΓöÇ */}
...
class AdmsService
{
    ...
    public function verifyWebhook(string $rawPayload, string $signature): bool
    {
        ...
        return hash_equals($expected, $signature);
              ...
              <div>
                <p className="text-[11px] font-black text-slate-500 uppercase tracking-widest mb-2">4. Controller ΓÇö Buat Invoice & Redirect</p>
                <CodeBlock lang="php" code={`<?php
    ...
    public function createInvoice(Request $request, AdmsService $adms)
    {
        ...
        return redirect($result['data']['paymentLink']);
              ...
              <div>
                ...
                <CodeBlock lang="php" code={`// routes/api.php ΓÇö tambahkan route webhook
Route::post('/webhook/adms', [WebhookController::class, 'handle'])
     ->name('webhook.adms')
     ->withoutMiddleware(\\App\\Http\\Middleware\\VerifyCsrfToken::class);
...
class WebhookController extends Controller
{
    ...
    {
        // Verifikasi signature ΓÇö gunakan RAW body, bukan parsed JSON
        $signature = $request->header('X-ADMS-Signature', '');
        ...
        return response('OK', 200);
            ...
            <div className="mt-4">
              <InfoBox variant="tip">
                Gunakan <code className="font-mono">Http::withToken()</code> dari Laravel ΓÇö ini otomatis menambahkan
          ...
          {/* ΓöÇΓöÇ INTEGRASI REACT/JS ΓöÇΓöÇ */}
...
module.exports = router;`} />
              ...
              <div>
                <p className="text-[11px] font-black text-slate-500 uppercase tracking-widest mb-2">2. React Hook ΓÇö Buat Pembayaran</p>
      ...
      >
        {isLoading ? 'Memproses...' : 'Bayar via QRIS'}
              ...
              <div>
                ...
                <CodeBlock lang="jsx" code={`// hooks/usePaymentStatus.js ΓÇö polling setiap 5 detik
  ...
  return (
    <div>
      ...
      {status === 'EXPIRED' && <p className="text-gray-500">Invoice kedaluwarsa.</p>}
          ...
          {/* ΓöÇΓöÇ STATUS TRANSAKSI ΓöÇΓöÇ */}
